...
docker build -t insightface:retinaface-R50 --build-arg=DEFAULT_MP_NAME=retinaface-R50 --build-arg=DEFAULT_MP_NAME_DOWNLOAD_URL=http://my.nas/softwares/models/retinaface-R50.zip - < Dockerfile
```
